        ...
        <div class="col-md-4">
            <div class="card p-3">
                <div class="d-flex align-items-center justify-content-between">
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" value="queued" id="filterQueued"
                               ...
                               onclick="window.location='{{ route('manufacturing.job_pool.index', ['status'=>'queued']) }}'">
                ...
                <input type="text" class="form-control mt-3" placeholder="{{ __('Search by Job # / Customer / Series') }}"
                       value="{{ request('q') }}"
                       onkeydown="if(event.key==='Enter'){window.location='{{ route('manufacturing.job_pool.index') }}?q='+encodeURIComponent(this.value)}">
            </div>
        </div>
        <div class="col-md-4">
            <div class="card p-3">
                ...
                <div class="d-flex gap-2">
                    <a href="{{ route('manufacturing.job_pool.index') }}" class="btn btn-outline-secondary w-50">{{ __('Clear') }}</a>
                    <a href="{{ route('manufacturing.job_pool.create') }}" class="btn btn-primary customModal w-50"
                ...
                <div class="p-3">
                    ...
                    <div class="mt-auto">
                        <a href="#" class="btn btn-lg w-100 text-white" style="background:#a70f0f; border-radius: 18px;"
                           ...
                           data-url="{{ route('manufacturing.job_pool.show', $job->id) }}"
