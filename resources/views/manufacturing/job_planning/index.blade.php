...
@push('styles')
<style>
  /* Ensure the "Open Job" button is always clickable */
  .jp-open-btn { position: relative; z-index: 10; pointer-events: auto; }
  /* If you have decorative overlays inside cards, make them click-through */
  .card .overlay, .card .ghost-link { pointer-events: none; }
</style>
@endpush
...
@php
    ...
    // Ensure $jobs exists so view never fatals
    $jobs = $jobs ?? collect();
    ...
    <div class="col-12 col-sm-6 col-lg-4 col-xxl-3">
      <div class="card h-100 shadow-sm rounded-3 overflow-hidden">
        ...
        <div class="p-3">
          ...
          @if($first)
            <a href="#"
               class="btn w-100 text-white customModal jp-open-btn"
