                ...
                <div class="row align-items-center g-2">
                    ...
                    <div class="col-auto">
                        <a href="#" class="btn btn-primary customModal"
                           data-size="lg"
                           data-url="{{ route('inventory.purchase-requests.create') }}"
                           data-title="{{ __('Create Purchase Request') }}">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="#" class="btn btn-sm btn-info customModal"
                                       data-size="lg"
                                       data-url="{{ route('inventory.purchase-requests.edit', $request->id) }}"
                                       data-title="{{ __('Edit Purchase Request') }}">
