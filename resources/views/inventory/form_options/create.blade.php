<div class="modal fade" id="addOptionModal" tabindex="-1" aria-labelledby="addOptionModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-xl">
    <div class="modal-content">
      <form method="POST" action="{{ route('form-options.options.store') }}">
        @csrf
          ...
          <div id="glassSetsContainer" style="display: none;">
            <div class="glass-set mb-3">
              ...
              <div class="row mb-2">
                ...
                <div class="col-md-4">
                  <input type="text" name="glass_sets[0][prices][{{ $i }}]" class="form-control" placeholder="Price">
                </div>
              </div>
              @endforeach
            </div>
