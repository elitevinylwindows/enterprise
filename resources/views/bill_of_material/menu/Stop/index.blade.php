...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item active" aria-current="page">{{ __('Stop') }}</li>
@endsection
                            ...
                            @foreach($stop as $item)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <form action="{{ route('stop.destroy', $item->id) }}" method="POST" class="d-inline">
                                            @csrf @method('DELETE')
...
<div class="modal fade" id="addItemModal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            @include('bill_of_material.menu.Stop.create')
        </div>
    </div>
</div>
...
@foreach($stop as $item)
    <div class="modal fade" id="editItemModal{{ $item->id }}" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content">
                @include('bill_of_material.menu.Stop.edit', ['item' => $item])
            </div>
        </div>
    </div>
@endforeach
