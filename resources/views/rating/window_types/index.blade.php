...
<div class="d-flex justify-content-between align-items-center mb-3">
  ...
  <a href="{{ route('admin.nfrc.window-types.create') }}" class="btn btn-primary">New Type</a>
</div>
      ...
      <tbody>
        @forelse($types as $t)
          <tr>
            ...
            <td class="text-end">
              <a href="{{ route('admin.nfrc.window-types.edit',$t) }}" class="btn btn-sm btn-outline-primary">Edit</a>
              <form action="{{ route('admin.nfrc.window-types.destroy',$t) }}" method="POST" class="d-inline"
