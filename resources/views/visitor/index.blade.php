    ...
    @if (Gate::check('create visitor'))
        <a class="btn btn-secondary btn-sm ml-20 customModal" href="#" data-size="lg"
            data-url="{{ route('visitor.create') }}" data-title="{{ __('Create Visitor') }}"> <i
                class="ti-plus mr-5"></i>{{ __('Create Visitor') }}</a>
    @endif
@endsection
@section('content')
    <div class="row">
                        ...
                        @if (Gate::check('create visitor'))
                            <div class="col-auto">
                                <a class="btn btn-secondary customModal" href="#" data-size="lg"
                                    data-url="{{ route('visitor.create') }}" data-title="{{ __('Create Visitor') }}"> <i
                                        class="ti ti-circle-plus align-text-bottom"></i> {{ __('Create Visitor') }}</a>
                            </div>
                        @endif
                    </div>
                </div>
                        ...
                        <table class="table table-hover advance-datatable">
                            <thead>
                                <tr>
                                    ...
                                    <th>{{ __('Exit Time') }}</th>
                                    <th>{{ __('Status') }}</th>
                                    @if (Gate::check('edit visitor') || Gate::check('delete visitor') || Gate::check('show visitor'))
