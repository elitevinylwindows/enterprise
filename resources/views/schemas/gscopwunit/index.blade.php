...
<tbody>
    ...
    <tr>
        ...
        <td>{{ $gscopwunit->onele3_oneclr_temp }}</td>
        <td>{{ $gscopwunit->lam_temp }}</td>
        <td>{{ $gscopwunit->feat1 }}</td>
        <td>{{ $gscopwunit->feat2 }}</td>
        <td>{{ $gscopwunit->feat3 }}</td>
        <td>{{ $gscopwunit->clr_clr }}</td>
        <td>{{ $gscopwunit->le3_clr_le3 }}</td>
        <td>{{ $gscopwunit->twole3_oneclr_temp }}</td>
        <td>{{ $gscopwunit->sta_grid }}</td>
        <td>{{ $gscopwunit->tpi }}</td>
        <td>{{ $gscopwunit->tpo }}</td>
