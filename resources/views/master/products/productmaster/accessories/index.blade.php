...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item active" aria-current="page">{{ __('Accessories') }}</li>
@endsection

@section('card-action-btn')
    <a href="#" class="btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#createModal">
        <i data-feather="plus"></i> {{ __('Add Accessories') }}
    </a>
@endsection
...
<th>{{ __('Color Management') }}</th>
<th>{{ __('Product Code Template') }}</th>
<th>{{ __('Sort Order') }}</th>
...
<td>{{ $item->color_management }}</td>
<td>{{ $item->product_code_template }}</td>
