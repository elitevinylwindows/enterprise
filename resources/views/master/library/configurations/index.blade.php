...
@section('card-action-btn')
    {{-- Removed Add Category from top; moved to below folder grid --}}
@endsection
    ...
    <div class="col-sm-12">
        <div class="card table-card mb-5">
            <div class="card-header">
                <h5>{{ __('Configuration Library') }}</h5>
            </div>
            ...
            <div class="card-body">
                ...
                <div class="row g-3 px-3 mb-6">
                    @foreach ($seriesList as $seriesName => $categories)
                        <div class="col-md-3">
                            <div class="card text-center shadow-sm series-folder" style="cursor:pointer;" data-series="{{ $seriesName }}">
                                <div class="card-body">
