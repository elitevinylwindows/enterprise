    ...
    <ul class="pc-submenu">
        ...
        <li class="pc-item pc-hasmenu">
            ...
            <ul class="pc-submenu" style="display: none;">
                ...
                <li class="pc-item <?php echo e(request()->routeIs('routes.driver') ? 'active' : ''); ?>">
        ...
        <?php if(
            Gate::check('manage shipping settings')): ?>
         <li class="pc-item pc-hasmenu">
            <a href="<?php echo e(route('settings.shipping')); ?>" class="pc-link d-flex justify-content-between align-items-center" onclick="toggleSubmenu(this)">
                <span>Settings</span>
                <span class="ms-auto icon-wrapper">
                </span>
            </a>
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home4/aizwmjte/sr.elitevinylwindows.com/resources/views/admin/menu.blade.php ENDPATH**/ ?>