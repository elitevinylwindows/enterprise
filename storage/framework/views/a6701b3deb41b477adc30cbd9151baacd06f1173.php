                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="flex-grow-1 ms-3">
                            <p class="mb-1"><?php echo e(__('Total Quotes')); ?></p>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="flex-grow-1 ms-3">
                            <p class="mb-1"><?php echo e(__('Total Orders')); ?></p>
                            <div class="d-flex align-items-center justify-content-between">
                                <h4 class="mb-0"></h4>
                            </div>
                        </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="flex-grow-1 ms-3">
                            <p class="mb-1"><?php echo e(__('Total Invoices')); ?></p>
                            <div class="d-flex align-items-center justify-content-between">
                                <h4 class="mb-0"></h4>
                            </div>
                        </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="flex-grow-1 ms-3">
                            <p class="mb-1"><?php echo e(__('Total Completed')); ?></p>
                            <div class="d-flex align-items-center justify-content-between">
                                <h4 class="mb-0">
                                </h4>
                            </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex align-items-start justify-content-between">
                        <div>
                            <h5 class="mb-1"><?php echo e(__('Chart')); ?></h5>
...
<div class="row">
    ...
    <div class="col-md-3">
        <div class="card h-100">
            <div class="card-header">
                <h5><?php echo e(__('Quick Stats')); ?></h5>
            </div>
            <div class="card-body">
    ...
    <div class="col-md-9">
        ...
        <div class="card mb-4">
            <div class="card-header">
                <h5><?php echo e(__('Recent Quotes')); ?></h5>
            </div>
            <div class="card-body">
...
<?php $__env->startPush('script-page'); ?>
    <script>
        var options = {
            ...
            series: [{
                name: "<?php echo e(__('Total Deliveries')); ?>",
                type: 'column',
                data: ,
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home4/aizwmjte/sr.elitevinylwindows.com/resources/views/sales/dashboard/index.blade.php ENDPATH**/ ?>