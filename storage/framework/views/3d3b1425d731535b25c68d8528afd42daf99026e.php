...
<form method="GET" action="<?php echo e(route('calculator.index')); ?>">
...
<?php
 $allItems = [
  ['label' => 'Frame Type', 'field' => 'frame_type', 'measure' => 'L In', 'hasSubmenu' => false, 'condition_group' => 'Frame Type'],
    ...
    ['label' => 'Roller Track', 'field' => 'track', 'measure' => 'L In', 'hasSubmenu' => false, 'condition_group' => 'Track'],
...
['label' => 'Sash', 'field' => 'sash', 'measure' => 'L In', 'need' => 0],
              ...
              ['label' => 'Interlock Reinforcement', 'field' => 'interlock_reinf', 'measure' => 'Qty', 'need' => 0],
              ...
              ['label' => 'Grid Type', 'field' => 'grids', 'measure' => 'L In', 'need' => 0],
              ...
              ['label' => 'Mull Screw', 'field' => 'mull_screw', 'measure' => 'Qty'],
              ['label' => 'Reinforcement Material', 'field' => 'reinforcement_material', 'measure' => '-'],
              ['label' => 'Steel Reinforcement', 'field' => 'steel_reinforcement', 'measure' => 'Qty'],
              ['label' => 'Aluminum Reinforcement', 'field' => 'aluminum_reinforcement', 'measure' => '-'],
               ['label' => 'Screen', 'field' => 'screen', 'measure' => 'L In'],
...
?>
  ...
  <select name="bom[<?php echo e($item['field']); ?>]" class="form-select">
    ...
    <?php $__currentLoopData = $menuOptions[$item['label']] ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $opt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
<option value="<?php echo e($opt->id); ?>"><?php echo e($opt->name); ?></option>
  ...
  <?php if(!empty($item['hasSubmenu'])): ?>
    <?php if ($__env->exists('components.submenu-dropdown', [
      'type' => $item['condition_group'],
      'rowData' => $item
    ])) echo $__env->make('components.submenu-dropdown', [
      'type' => $item['condition_group'],
      'rowData' => $item
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home4/aizwmjte/sr.elitevinylwindows.com/resources/views/bill_of_material/calculator/index.blade.php ENDPATH**/ ?>