<?php $__env->startSection('page-title'); ?>
    <?php echo e(__('DH Units')); ?>

<?php $__env->stopSection(); ?>

<?php $__env->startSection('breadcrumb'); ?>
    <li class="breadcrumb-item"><a href="{ route('dashboard') }"><?php echo e(__('Dashboard')); ?></a></li>
    <li class="breadcrumb-item" aria-current="page"><?php echo e(__('DH Units')); ?></li>
<?php $__env->stopSection(); ?>
                    ...
                    <table class="table table-hover advance-datatable" id="dhUnitsTable">
                        <thead>
                            <tr>
                                ...
                                <th><?php echo e(__('Twole3 Oneclr Temp')); ?></th>
                        ...
                        <tbody>
                            <?php $__currentLoopData = $dhunits; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $unit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td><?php echo e($unit->twole3_oneclr_temp); ?></td>
                                    ...
                                    <td>
                                        <a href="#" class="btn btn-sm btn-info customModal"
                                           data-size="lg"
                                           data-url="<?php echo e(route('dh-unit.edit', $unit->id)); ?>"
                                           data-title="<?php echo e(__('Edit DH Unit')); ?>">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home4/aizwmjte/sr.elitevinylwindows.com/resources/views/schemas/dhunit/index.blade.php ENDPATH**/ ?>