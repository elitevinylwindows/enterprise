...
<?php $__env->startSection('page-title', 'My Kanban'); ?>
...
<div class="row">
            ...
            <div class="card bg-light rounded kanban-status" style="min-width: 280px;">
               <div class="card-header bg-white text-center font-weight-bold">
                ...
                <div class="card-body kanban-column" data-status="<?php echo e($statusKey); ?>">
                   <?php $__currentLoopData = $leadsByStatus[$statusKey] ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lead): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <div class="card mb-2 p-2 shadow-sm customModal"
        ...
        <?php if($lead->phone): ?>
            <a href="tel:<?php echo e(preg_replace('/\D/', '', $lead->phone)); ?>"
        ...
        <strong><?php echo e($lead->name); ?></strong><br>
        <small><?php echo e($lead->phone); ?> | <?php echo e($lead->email); ?></small>
    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home4/aizwmjte/sr.elitevinylwindows.com/resources/views/leads/mykanban.blade.php ENDPATH**/ ?>