...
<div class="row mb-3 align-items-end">
     ...
     <div class="col-md-6">
        ...
        <div class="d-flex gap-2">
            ...
            <a href="#" class="btn btn-primary d-flex align-items-center justify-content-center"
               style="height: 44px;" data-bs-toggle="modal" data-bs-target="#configLookupModal">
    ...
    <div class="col-md-2 text-end">
        <a href="#" class="btn btn-primary w-100 d-flex align-items-center justify-content-center"
           style="height: 44px;" data-bs-toggle="modal" data-bs-target="#addItemModal">
...
<?php endif; ?>
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home4/aizwmjte/app.elitevinylwindows.com/resources/views/sales/quotes/details.blade.php ENDPATH**/ ?>