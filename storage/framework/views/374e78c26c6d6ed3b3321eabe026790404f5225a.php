...
<div id="kanban-scroll-wrapper" class="horizontal-scroll">
        ...
        <?php $__currentLoopData = $statuses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $statusKey => $statusLabel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="kanban-column-wrapper">
                <div class="card bg-light">
                    ...
                    <div class="card-body kanban-column" data-status="<?php echo e($statusKey); ?>">
                        <?php $__currentLoopData = $leadsByStatus[$statusKey]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $card): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          <div class="kanban-card card mb-2 position-relative customModal"
     data-id="<?php echo e($card->id); ?>"
     data-url="<?php echo e(route('leads.edit', $card->id)); ?>"
     data-title="Edit Lead"
     data-size="lg">

    
    <?php if($card->phone): ?>
        <a href="tel:<?php echo e(preg_replace('/\D/', '', $card->phone)); ?>"
    ...
    <div class="card-body p-2 pe-4">
        <strong><?php echo e($card->name); ?></strong><br>
        <small><?php echo e($card->phone); ?></small>
    </div>
</div>
    ...
    $(function () {
        $(".kanban-column").sortable({
            ...
            receive: function (event, ui) {
                ...
                $.ajax({
                    url: "<?php echo e(route('leads.kanban.update-status')); ?>",
                    type: "POST",
                    data: {
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home4/aizwmjte/sr.elitevinylwindows.com/resources/views/leads/kanban.blade.php ENDPATH**/ ?>