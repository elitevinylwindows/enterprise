<?php echo Form::open(['route' => 'inventory.stock-level.store', 'method' => 'post']); ?>
...
<div class="modal-body">
    <div class="row">
        ...
        <div class="form-group col-md-6">
            ...
            <?php echo Form::select('location_id', $locations, null, ['class' => 'form-control', 'placeholder' => 'Select Location']); ?>
...
<?php /**PATH /home4/aizwmjte/app.elitevinylwindows.com/resources/views/inventory/stock_levels/create.blade.php ENDPATH**/ ?>