<form action="<?php echo e(route('stop.update', $item->id)); ?>" method="POST">
...
<?php /**PATH /home4/aizwmjte/sr.elitevinylwindows.com/resources/views/bill_of_material/menu/Stop/edit.blade.php ENDPATH**/ ?>