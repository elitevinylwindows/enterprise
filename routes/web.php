...
Route::prefix('email')->name('email.')->group(function () {
    Route::get('/', [EmailController::class, 'index'])->name('index');
        ...
        Route::prefix('sales')->name('sales.')->group(function () {
            ...
            Route::post('orders/{id}/rush', [\App\Http\Controllers\Sales\OrderController::class, 'markRush'])->name('orders.rush');
            ...
            Route::post('invoices/{id}/special', [\App\Http\Controllers\Sales\InvoiceController::class, 'markSpecialCustomer'])->name('invoices.special');
            Route::post('invoices/{id}/rush', [\App\Http\Controllers\Sales\InvoiceController::class, 'markRush'])->name('invoices.rush');
