...
HSUnit::create($validated);
        return redirect()->route('hsunit.index')->with('success', 'Created successfully.');
    }
...
$item = HSUnit::findOrFail($id);
        ...
        return redirect()->route('hsunit.index')->with('success', 'Updated successfully.');
    }
    ...
    public function destroy($id)
    {
        $item = HSUnit::findOrFail($id);
        $item->delete();
        return redirect()->route('hsunit.index')->with('success', 'Deleted successfully.');
    }
}
