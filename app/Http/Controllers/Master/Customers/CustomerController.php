  ...
  public function store(Request $request)
    {
        $request->validate([
            ...
            'receive_quote_via' => 'required|array',
            'receive_quote_via.*' => 'in:email,sms',
        ]);
        ...
        try {
            ...
            $customer = Customer::create([
                ...
                'receive_quote_via' => json_encode($request->receive_quote_via),
            ]);
    ...
    public function update(Request $request, $id)
    {
        ...
        try
        {
            ...
            DB::beginTransaction();
            $customer = Customer::findOrFail($id);
            $validated['receive_quote_via'] = json_encode($request->receive_quote_via);
